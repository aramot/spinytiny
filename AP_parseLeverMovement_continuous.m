function [lever_active lever_force_resample lever_force_smooth ...
    lever_velocity_envelope_smooth] = AP_parseLeverMovement_continuous(xsg_lever)
...
% get xsg sampe rate (should always be 10 kHz)
...
noise_cutoff = 1*prctile(lever_force_resample(~lever_active) - ...
    lever_force_smooth(~lever_active),99);
