function [square, floored,trueeventcount, topspikes, both] =  DetectEvents(data, threshold)
...
for i = 1:numberofSpines
    ...
    temp(d2tamp>0) = 0; %% For plateau spikes, when the 2nd derivative is positive (concave up, corresponding to dips), punch a 'hole' in the data, so that multiple peaks will be counted
    topspikes(i,:) = temp;
end
